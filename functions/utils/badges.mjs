...
import art from '../badges/art.json';
...
export const toPublicBadge = (badge) => ({
  ...
  icon: badge.icon,
  // Self-contained SVG artwork (data URI) generated by scripts/build-badge-art.mjs.
  // The UI prefers this over the emoji `icon` when present.
  ...(art[badge.id] && { iconUrl: art[badge.id] }),
